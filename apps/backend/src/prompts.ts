  ...
  return [
    {
      ...
      content: [
        ...
        "Vary reply structure across options: caveat, counterexample, tradeoff, implementation detail, pattern, constructive pushback, reasoned question, or concise add-on — not minor paraphrases of the same story tone.",
